...
When you read this document, you are learning what NOT to do. The banned patterns are your red flags. The normal implementations are your blueprint. Follow them strictly, and you will create UI that feels like Linear, Raycast, Stripe, or GitHub—not like another generic AI dashboard.
...
<div class="headline">
  ...
  <h2>One place to track what matters.</h2>
  <p>
    The layout stays strict and readable: live project health,
    activity, and near-term priorities without the usual filler.
  </p>
</div>
```
...
- Border radii in the 20px to 32px range across everything (use 8px-12px consistently)
- Repeating the same rounded rectangle on sidebar, cards, buttons, and panels
- Sidebar width around 280px with a brand block on top and nav links below (aim for 240px-260px)
...
- Eyebrow labels (e.g. "SNAPSHOT" uppercase with letter-spacing)
- Hero sections inside dashboards
- Decorative copy like "Operational clarity" as page headers
...
- Nav badges showing counts or "Live" status unless real
- Quota/usage panels with progress bars unless real
- Footer lines with meta information inside dashboards
